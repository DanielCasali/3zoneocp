...
locals {
  pvs_zone1 = {
    ...
    network_mask = cidrmask(var.region_entries.zone1.pvs_dc_cidr, 0)
  ...
  pvs_zone2 = {
    ...
    network_mask = cidrmask(var.region_entries.zone2.pvs_dc_cidr, 0)
  ...
  pvs_zone3 = {
    ...
    network_mask = cidrmask(var.region_entries.zone3.pvs_dc_cidr, 0)
