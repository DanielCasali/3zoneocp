...
resource "ibm_tg_connection" "test_ibm_tg_connection" {
  ...
  count = data.ibm_pi_workspace.this_workspace.pi_workspace_capabilities.cloud-connections == true ? 0 : 1
...
resource "ibm_pi_cloud_connection" "cloud_connection" {
  ...
  count = data.ibm_pi_workspace.this_workspace.pi_workspace_capabilities.cloud-connections == true ? 1 : 0
